    ...
    def run(self):
        ...
        if entitytype_data_path:
            ...
            with open(entitytype_data_path, 'r') as f:
                try:
                    op_create = entitytype.create_custom_entitytype(f.read(), credentials=self._credentials)
                    print(f'ret_code is {op_create}. \nCreate Entity Type Operation completed successfully')
        ...
        if constants_data_path:
            ...
            with open(function_data_path, 'r') as f:
                try:
                    op_add = kpifunction.add_functions(f.read(), credentials=self._credentials)
                    print(f'ret_code is {op_add}. \nAdd KPI Functions Operation completed successfully')
        ...
        if function_data_path:
            ...
            with open(dimension_data_path, 'r') as f:
                try:
                    op_add = dimension.add_dimensions_data(f.read(), credentials=self._credentials, )
                    print(f'ret_code is {op_add}. \nAdd dimension data Operation completed successfully')
        ...
        if dimension_data_path:
            ...
            with open(constants_data_path, 'r') as f:
                try:
                    op_create = constants.create_constants(f.read(), credentials=self._credentials)
                    print(f'ret_code is {op_create}. \nCreate Constants Operation completed successfully')
